...
const ContactPage = () => {
  ...
  const onSubmit = async (data: ContactFormValues) => {
    ...
    try {
      const response = await fetch("https://enlightiq.enlightiq.in/api/contact", {
        method: "POST",
        headers: {
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:collaborations@enlightiq.in"
                      className="text-education-blue hover:underline"
                      target="_blank"
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex space-x-4">
                  ...
                  <a
                    href="#"
                    className="bg-blue-100 p-2 rounded-full text-blue-400 hover:bg-blue-200 transition-colors"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
                  ...
                  <a
                    ...
                    className="bg-blue-100 p-2 rounded-full text-pink-600 hover:bg-blue-200 transition-colors"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
