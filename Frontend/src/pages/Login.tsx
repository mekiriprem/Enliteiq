...
</div>          <h1 className="mt-6 text-3xl font-bold text-education-dark dark:text-white">Welcome Back</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-300">Log in to continue your learning journey</p>
        </div>
